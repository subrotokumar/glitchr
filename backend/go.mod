module gitlab.com/subrotokumar/glitchr/backend

go 1.25.5

replace (
	gitlab.com/subrotokumar/glitchr/pkg/core => ../libs/core
	gitlab.com/subrotokumar/glitchr/pkg/idp => ../libs/idp
	gitlab.com/subrotokumar/glitchr/pkg/logger => ../libs/logger
	gitlab.com/subrotokumar/glitchr/pkg/queue => ../libs/queue
	gitlab.com/subrotokumar/glitchr/pkg/storage => ../libs/storage
)
